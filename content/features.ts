...
export const features: Features = {
   ...
   *    (처리방침 수립·공개) 관점에서 문제가 된다. 개인정보 보호책임자는 확정됐고(2026-09-13)
   *    국외 이전 고지도 확정했다(2026-09-14). 남은 것은 **사업자등록번호**뿐이다 —
   *    아직 등록 전이다. **등록증이 나오면 `content/site.ts` 의 `bizNo` 를 채우고
   *    `privacyPolicy` 를 켠다.** 그때까지는 이 플래그를 끄는 것이 안전한 선택이다
   *    — 사용자 판단으로 켜 둔 상태다(2026-09-10).
   */
  analytics: true,
